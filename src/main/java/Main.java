...
// затем  resource_en и если не находит нитого ни того берет resource(дефолтный)
            // ресурс пак из ResourcesBundle (принимает только String ключ String)(нетребует перекомпиляции)
    ResourceBundle bundleDef = ResourceBundle.getBundle("resources");// тут можно прописать путь где будут твои ресурсы
